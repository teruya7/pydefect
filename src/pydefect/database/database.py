...
def electronegativity(element) -> float:
    ...
    Returns:
        Electronegativity value or None.
...
def oxidation_state(element) -> int:
    """Get common oxidation state for an element.

    Args:
        element: Element symbol.

    Returns:
        Oxidation state integer.
    """

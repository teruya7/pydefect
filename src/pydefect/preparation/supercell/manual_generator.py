...
from pydefect.preparation.supercell.models.supercell import Supercell, Supercells
from pydefect.preparation.supercell.models.supercell_info import SupercellInfo, SimpleSite, \
    stripe_numbers
...
class ManualSupercellMaker:
    """Create supercell from manually specified sites.

    Attributes:
        supercell: Generated Supercell object.
        supercell_info: SupercellInfo with site data.

    Example:
        >>> sites = make_sites_from_yaml_file("sites.yaml")
        >>> maker = ManualSupercellMaker(structure, sites)
    ...
    def __init__(self,
                 ...
                 **supercell_kwargs):
        """Initialize ManualSupercellMaker.

        Args:
            input_structure: Input unit cell structure.
            sites: Dict mapping site names to SimpleSite objects.
            matrix: Optional 3x3 supercell transformation matrix.

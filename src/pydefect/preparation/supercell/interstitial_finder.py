...
from pydefect.analysis.structure.models import remove_dot
...
def make_local_extrema_from_volumetric_data(
    ...
    """Find local extrema in volumetric data.

    Args:
        volumetric_data: VASP volumetric data (CHGCAR, LOCPOT).
        params: Analysis parameters.
        info: Optional description string.
        find_min: If True, find minima; else find maxima.

    Returns:
        VolumetricDataLocalExtrema with interstitial sites.

    Example:
        >>> from pymatgen.io.vasp import Chgcar
        >>> chgcar = Chgcar.from_file("CHGCAR")
        >>> extrema = make_local_extrema_from_volumetric_data(chgcar, params)
    """

...
"""Interstitial-related CLI commands (ai, pi, le)."""
...
def register_commands(app: typer.Typer):
    """Register interstitial commands to the app."""
...
def register_vasp_commands(app: typer.Typer):
    """Register VASP-specific interstitial commands (le)."""

    @app.command(name="le", help="Find local extrema in volumetric data.")
    def local_extrema(

...
from pydefect.analyzer.transition_levels.transition_levels_plotter import (
    MplTLData, make_mpl_tl_data, TransitionLevelsMplPlotter
)
from pydefect.analyzer.transition_levels.transition_levels import TransitionLevel, TransitionLevels
...
class TestTransitionLevelsMplPlotter:
    ...
    def test_init_default(self):
        ...
        with patch('pydefect.analyzer.transition_levels.transition_levels_plotter.plt') as mock_plt:

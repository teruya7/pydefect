...
from pydefect.analysis.defect_structure.make_defect_structure_info import \
    MakeDefectStructureInfo
from pydefect.analysis.defect_structure.make_defect_vesta_file import fold_coords_in_structure

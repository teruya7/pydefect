...
from pydefect.makers.defect.defect import SimpleDefect
from pydefect.makers.defect.defect_entries_maker import (
    DefectEntriesMaker, copy_to_structure, to_istructure, add_atom_to_structure,
    perturb_structure, random_3d_vector)
from pydefect.makers.defect.defect_entry import DefectEntry, PerturbedSite
from pydefect.makers.defect.defect_set import DefectSet
from pydefect.makers.supercell.supercell_info import SupercellInfo, Site, \
    Interstitial
...
def test_defect_entries_maker(cubic_supercell_info, cubic_supercell, mocker):
    mock = mocker.patch("pydefect.makers.defect.defect_entries_maker.defaults")
...
def test_perturbed_structure(ortho_conventional, mocker):
    mock = mocker.patch(
        "pydefect.makers.defect.defect_entries_maker.random_3d_vector")
